...
<head>
	...
	<link href="/style/zTree/zTreeStyle.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="/js/jquery/jquery.js"></script>
	<script type="text/javascript" src="/js/jquery/plugins/zTree/jquery.ztree.core.js"></script>
		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
		 			<!-- <li><a href="javascript:" data-url="/employee_list">员工管理</a></li>
		 			<li><a href="javascript:" data-url="/department_list">部门管理</a></li>
		 			<li><a href="javascript:" data-url="/role_list">角色管理</a></li>
		 			<li><a href="javascript:" data-url="/permission_list">权限管理</a></li> -->
		 		</ul>
		 	</div>
		 </div>
	</div>
