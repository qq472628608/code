...
<body>
	<s:actionerror/>
	<s:form id="searchForm" namespace="/" action="depot_list" theme="simple">
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="http://localhost:8080/depot_edit"/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageQuery.queryResult">
								<tr>
									...
									<td>
										<s:a namespace="/" action="depot_edit"><s:param name="depot.id" value="id"/>编辑</s:a>
										<s:url namespace="/" action="depot_delete" var="urldata">
