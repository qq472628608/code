...
<body>
	<s:actionerror/>
	<s:form id="searchForm" namespace="/" action="stockIncomeBill_list" theme="simple">
		<div id="container">
				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="http://localhost:8080/stockIncomeBill_edit"/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageQuery.queryResult">
								<tr>
									...
									<s:if test="status==0">
									<td>
										<s:a namespace="/" action="stockIncomeBill_audit"><s:param name="stockIncomeBill.id" value="id"/>审核</s:a>
										<s:a namespace="/" action="stockIncomeBill_edit"><s:param name="stockIncomeBill.id" value="id"/>编辑</s:a>
										<s:url namespace="/" action="stockIncomeBill_delete" var="urldata">
