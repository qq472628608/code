		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<s:date name="stockIncomeBill.vdate" format="yyyy-MM-dd" var="vt"/>
						<s:textfield name="stockIncomeBill.vdate" cssClass="ui_input_txt02" value="%{vt}"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">供应商</td>
					<td class="ui_text_lt">
						<s:select list="#suppliers" name="stockIncomeBill.supplier.id" listKey="id" listValue="name" cssClass="ui_select01"/>
					</td>
				</tr>
				<tr>
