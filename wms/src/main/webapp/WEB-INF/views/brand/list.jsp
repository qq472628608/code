...
<body>
	<s:actionerror/>
	<s:form id="searchForm" namespace="/" action="brand_list" theme="simple">
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_bottom">
							<input type="button" value="批量删除" class="ui_input_btn01 btn_bathDelete" data-url="/brand_bathDelete"/>
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="http://localhost:8080/brand_edit"/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageQuery.queryResult">
								<tr>
									...
									<td>
										<s:a namespace="/" action="brand_edit"><s:param name="brand.id" value="id"/>编辑</s:a>
										<s:url namespace="/" action="brand_delete" var="urldata">
