...
<script type="text/javascript">
	...
	function getJson(json){
		...
		tr.find("input[tag=salePrice]").val(json.salePrice);
	}
	$(function(){ 
		$("#edit_table_body").on("click",".searchproduct",function(){
			...
			tr.find("[tag=amount]").html(Number(salePrice*number).toFixed(2));
...
<body>
<s:form name="editForm" action="stockOutcomeBill_saveOrUpdate" namespace="/" theme="simple" id="editForm">
	<s:hidden name="stockOutcomeBill.id"/>
	<div id="container">
		<div id="nav_links">
			<span style="color: #1A5CC6;">销售出库订单编辑</span>
		</div>
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<s:date name="stockOutcomeBill.vdate" format="yyyy-MM-dd" var="vt"/>
						<s:textfield name="stockOutcomeBill.vdate" cssClass="ui_input_txt02" value="%{vt}"/>
					</td>
				</tr>
				<tr>
