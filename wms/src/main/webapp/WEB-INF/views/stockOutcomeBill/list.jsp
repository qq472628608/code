...
<body>
	<s:actionerror/>
	<s:form id="searchForm" namespace="/" action="stockOutcomeBill_list" theme="simple">
		<div id="container">
				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							...
							客户
							<s:select list="#clients" listValue="name" listKey="id" name="bq.clientId" headerKey="-1" headerValue="请选择" cssClass="ui_select01"/>
							仓库
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="http://localhost:8080/stockOutcomeBill_edit"/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageQuery.queryResult">
								<tr>
									...
									<s:if test="status==0">
									<td>
										<s:a namespace="/" action="stockOutcomeBill_audit"><s:param name="stockOutcomeBill.id" value="id"/>审核</s:a>
										<s:a namespace="/" action="stockOutcomeBill_edit"><s:param name="stockOutcomeBill.id" value="id"/>编辑</s:a>
										<s:url namespace="/" action="stockOutcomeBill_delete" var="urldata">
