...
<body>
	<s:actionerror/>
	<s:form id="searchForm" namespace="/" action="role_list" theme="simple">
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_bottom">
							<input type="button" value="批量删除" class="ui_input_btn01 btn_bathDelete" data-url="/role_bathDelete"/> 
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="http://localhost:8080/role_edit"/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageQuery.queryResult">
								<tr>
									...
									<td>
										<s:a namespace="/" action="role_edit"><s:param name="role.id" value="id"/>编辑</s:a>
										<s:url namespace="/" action="role_delete" var="urldata">
